            ...
            <div id="table">
                <table id="datatables-dashboard-projects" class="table table-striped my-0 ">
                    ...
                    <tr>
                        ...
                        <th class="col">Produtos_Alert</th>
                    ...
                    <?php if (is_array($planograms)) {
                        foreach ($planograms as $planogram) { ?>
                            <tr id="scenario-<?php echo $planogram["id"] ?>">
                                ...
                                <td>
                                    <?php echo $planogram["customization"]; ?>
                                </td>

                                <td>
                                    <div class="d-inline-block dropdown show">
                                        <a class="btn btn-sm btn-icon-only" href="<?php echo base_url('/index.php/alert_product_view?planogram_id=' . $planogram['id']); ?>">
...
<!--                                            --><?php //foreach($planogram['urlprintPlanogram'] as $k => $v) { if($v != ''){?>
<!--                                                <a class="dropdown-item" href="--><?php //echo base_url('/index.php/alert_product_view?product_id=' . $k . '&planogram_id=' . $planogram['id']); ?><!--">--><?php //echo $v ?><!--</a>-->
<!--                                            --><?php //}}?>
<!--                                        </div>-->
                                    </div>
                                </td>
