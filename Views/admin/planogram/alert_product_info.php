            ...
            <div id="table">
                <table id="datatables-dashboard-projects" class="table table-striped my-0 ">
                    ...
                    <tr>
                        ...
                        <th class="col">scenario</th>
                        <th class="col">Front_count</th>
                        <th class="col">Total_count</th>
                        <th class="col">Alert_count</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if (is_array($planograms)) {
                        foreach ($planograms as $planogram) { ?>
                            <tr id="scenario-<?php echo $planogram["id"] ?>">
                                <td><?php echo $planogram["id"]; ?>
                                <td><?php echo $planogram["product_name"]; ?>
                                    <div class="d-none" id="id_scenario"><input name="id_scenario" type="hidden" value="<?php echo $planogram["id"] ?>">
                                        <div>
                                </td>
                                <td>
                                    <?php echo $planogram["scenario_name"]; ?>
                                </td>
                                <td>
                                    <?php echo $planogram["views"]; ?>
                                </td>
                                <td>
                                    <?php echo $planogram["qty"]; ?>
                                </td>
                                <td>
                                    <?php echo $planogram["alert_count"]; ?>
                                </td>
                            </tr>
