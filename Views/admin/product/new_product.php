            ...
            <div class="card-header border-0" style="background-color: #fc9700;">
                <div class="row align-items-center col-12 ">
                    <div class="col-12 col-md-8 col-sm-8 col-lg-8 col-xl-8 col-xl-8" style="background-color: #fc9700;">
                        <h3 class="mb-0 text-white">Adicionar Produtos</h3>
                    </div>
                    <div class="col-12 col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xl-4 text-right p-0 mt-1">
                        <a href="import_export"><button class="btn btn bg-white float-end m-1">Importar/Exportar produtos</button></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <h6 class="card-subtitle text-muted mt-2">Informações do Produto</h6>
                <hr class="mt-2" />
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="mt-2 form-control-label" for="name">Nome do Produto</label>
                                <input type="text" id="name" name="name" class="mt-2 form-control form-control-alternative" placeholder="Nome do Produto" required>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="price" name="price" class="mt-2 money form-control form-control-alternative" placeholder="Preço do Produto">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="brand" name="brand" class="mt-2 form-control form-control-alternative" placeholder="Marca do Produto" required>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label class="mt-2 form-control-label" for="brand">Fabricante</label>
                                <input type="text" id="producer" name="producer" class="mt-2 form-control form-control-alternative" placeholder="Fabricante do Produto">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="mt-2 form-control-label" for="grammage">Gramatura </label>
                                <input type="text" id="grammage" name="grammage" class="mt-2 form-control form-control-alternative" placeholder="Gramatura do Produto" required>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="feature" name="feature" class="mt-2 form-control form-control-alternative" placeholder="Sabor (para comestíveis), Aroma (para produtos de limpeza), Cor (para roupas e objetos)">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="mt-2 form-control-label" for="ean">Ean do Produto</label>
                                <input type="text" name="ean" id="ean" class="mt-2 form-control form-control-alternative" placeholder="Ean do Produto" required>
                        ...
                        <div class="col-lg-2" id="checkbox">
                            <div class="form-group">
                                <label class="form-check mt-2">
                                    ...
                                    <div id="info" title="Código único de identificação do produto." data-mdb-toggle="tooltip" data-mdb-placement="bottom"><i class="fas fa-info-circle"></i></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="mt-2 form-control-label" for="category">Categoria do Produto</label>
                        ...
                        <div class="col-lg-12 text-center mt-3">
                            <input id="submit-dropzone" class="botao bg-orange text-white" type="submit" onclick="enviaForm()" name="submitDropzone" value="Cadastrar Produto" />
                        </div>
                    </div>
                </form>
...
<script>
    function enviaForm() {
        ...
        if (eanValue == '') {
            ...
            if (logError == '') {
                $.ajax({
                        url: "<?php echo base_url('index.php/add_product') ?>",
                        type: 'post',
                        data: formData,
                        contentType: false,
                        processData: false
