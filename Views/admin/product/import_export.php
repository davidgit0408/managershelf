    ...
    <div class="col-md-12 container mt-3">
        <div class="card">
            ...
            <div class="card-body mb-5">
                ...
                <hr class="mt-2"/>              
                <form method="post" enctype="multipart/form-data" action="import_csv" class="validation-wizard wizard-circle m-t-40" >
    ...
    <div class="col-md-12 container mt-3">
        <div class="card">
            <div class="card-header border-0" style="background-color: #fc9700;">
                <div class="row align-items-center col-12 ">
                    <div class="col-12 col-md-8 col-sm-8 col-lg-8 col-xl-8 col-xl-8" style="background-color: #fc9700;">
                        <h3 class="mb-0 text-white">Exportar Produtos</h3>
                    </div>                                        
                    <div class="col-12 col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xl-4 text-right p-0 mt-1">
                        <a href="all_products"><button class="btn btn bg-white float-end m-1">Ver todos</button></a>
                    </div>
                </div> 
            </div>
            <div class="card-body wizard-content">
            <h6 class="card-subtitle text-muted mt-2">Exporte os produtos filtrando por categoria, marca e/ou fabricante</h6>
            <hr class="mt-2"/>              
            <?php if($error_msg){ ?>
            <div class="alert alert-danger alert-dismissible" role="alert">
                <div class="alert-message">
            ...
            <?php } ?>
                <form method="post" enctype="multipart/form-data" action="<?= base_url('index.php/export_csv') ?>" class="row validation-wizard wizard-circle m-t-40" >
                    <div class="col-lg-4">
                        <div class="form-group">
