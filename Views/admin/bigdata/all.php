		...
		<div class="card flex-fill p-3">
		    <div class="row align-items-center col-12 mb-3">
                ...
                <div class="col-12 col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xl-4 text-right p-0 mt-1">
                    <a href="import" class="col-5 btn btn-github text-white float-end m-1" >Importar/Exportar</a>
                </div>
            </div>
			...
			<table class="table table-striped my-0 ">
				<thead>
					<tr>
                        <th class="d-md-table-cell sortable <?php echo ($orderBy == 'ID') ? strtolower($order) : '' ?>" onclick="mudarOrdenacao('orderBy', 'ID')">ID</th>
                        <th class="sortable <?php echo ($orderBy == 'NAME') ? strtolower($order) : '' ?>" onclick="mudarOrdenacao('orderBy', 'NAME')">Nome</th>
                        <th class="d-md-table-cell">Marca</th>
                        <th class="d-md-table-cell">Característica</th>
                        <th class="d-md-table-cell">Fabricante</th>
				...
				<tbody>
    				...
    				<tr>
                        <td class="d-md-table-cell"><?php echo $product["id"] ?></td>
                        <td><?php echo $product["name"] ?> </td>
                        <td class="d-md-table-cell"><?php echo $product["brand"] ?> </td>
                        <td class="d-md-table-cell"><?php echo $product["feature"] ?> </td>
                        <td class="d-md-table-cell"><?php echo $product["producer"] ?> </td>
                        <td><?php echo $product["ean"] ?> </td>
                        <td class="d-md-table-cell text-right">
                            <div class="dropdown show d-flex justify-content-end">
                                <a class="btn btn-sm btn-icon-only fc-direction-rtl" href="#" data-bs-toggle="dropdown" data-bs-display="static"  >
                                    <i class="fas fa-ellipsis-v"></i>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="<?php echo base_url('index.php/bigdata/edit/'.$product['id']) ?>">Editar Produto</a>
...
function deleta(product){
    let id = $(product).data('id');
    window.location.href= "<?php echo base_url('index.php/bigdata/delete?id=') ?>"+id;
}
