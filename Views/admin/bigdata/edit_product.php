          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="mt-2 form-group">
                ...
                <input type="text" id="category" name="category" class="mt-2 form-control form-control-alternative" placeholder="Categoria do Produto"value="<?php echo $product['category'] ?>" required>
              ...
              <div class="col-lg-6 mt-1">
                ...
                <div data-bs-toggle="modal" data-bs-target="#sizedModalLg" id="img360" style="min-height: 150px;border: 1px solid #000;display: flex;align-items: center;justify-content: center;text-align: center;cursor: pointer;" class="mt-2 mb-5">
                  <img class="img360" src="<?php if (!$product_image360 == null) {
                                              echo base_url($product_image360);
                                            } ?>" height="170px" />
...
<script>
  function enviaForm() {
    ...
    if (eanValue == '') {
      ...
      if (logError == '') {
        $.ajax({
            url: "<?php echo base_url('index.php/bigdata/update') ?>",
            type: 'post',
            data: formData,
            contentType: false,
            processData: false
          ...
          .done(function(msg) {
            location.href = "<?php echo base_url('index.php/bigdata/all?order=DESC&orderBy=ID') ?>"
          })
          .fail(function(jqXHR, textStatus, msg) {
            console.log(msg)
          });
