...
$routes->get("/edit_alert_planogram", 'AdminController::edit_alert_planogram', $auth);
$routes->get("/setores", 'AdminController::setores', $auth);
...
$routes->get("/new_bigdata", 'AdminController::new_bigdata', $auth);
$routes->get("/import_export", 'AdminController::import_export', $auth);
$routes->get("/import_export_base", 'AdminController::import_export_base', $auth);
...
$routes->add("/add_bigdata", 'AdminController::add_bigdata');
...
$routes->add("/edit_alert_planogram", 'AdminController::edit_alert_planogram');
...
$routes->match(['get', 'post'], '/get_base_produtos', 'AdminController::get_base_produtos');
$routes->match(['get', 'post'], '/check_produtos', 'AdminController::check_produtos');
$routes->match(['get', 'post'], '/check_base_produtos', 'AdminController::check_base_produtos');
